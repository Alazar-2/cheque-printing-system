...
namespace AbayChequeMagic.Login
{
    public partial class Login : Form
    {
        ...
        {
            //viewusergroup ug = new viewusergroup();
            //string username=txtUserName.Text;
            //Boolean stat = ug.getListofAvailableUsers(username);
               if(true)
               {
	...
	//
        string connectionString = connectionString = "provider=MySql.Data.MySqlClient;provider connection string=&quot;server=localhost;user id=root;database=hr&quot;"; 
	   //
    ...
    static void notMain(string[] args)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            conn.ConnectionString = "Server=localhost;Database=hr;Trusted_Connection=true";
            conn.Open();
            // Create the command
