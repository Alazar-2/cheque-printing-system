...
namespace AbayChequeMagic
{
    public partial class MyMessageBox : Form
    {
        ...
        #region About MyMessagebox

        /************** Written by Rinesh PK on 18-09-2012 ******************/
        //                                                                  //
        /////// Custom MessageBox for Windows Forms Applications /////////////
        //                                                                  //
        //        1: use the function MyMessageBox.ShowBox()                //
        //        2: use MyMessageBox.Buttons for buttons                   //
        //        3: use MyMessageBox.Icons for Icons                       //
        //        4: use MyMessageBox.Result for DialogResult               //
        //        5: MessageBox timer canbe enbled by uncommenting some     //
        //           commented code mentioned bellow                        //
        //                                                                  //
        //////////////////////////////////////////////////////////////////////
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            //uncomment these to enable timer
            newMessageBox.Close();
        }
        ...
        private void pnlTitle_Paint(object sender, PaintEventArgs e)
        {
            ...
            Rectangle Area1 = new Rectangle(0, 0, this.Width - 1, this.Height - 1);
            LinearGradientBrush LGB = new LinearGradientBrush(Area1, Color.Maroon, Color.Gray, LinearGradientMode.ForwardDiagonal);
            mGraphics.FillRectangle(LGB, Area1);
            mGraphics.DrawRectangle(pen1, Area1);
        ...
        private void pbxClose_Click(object sender, EventArgs e)
        {
            /*  newMessageBox.msgTimer.Stop();
                newMessageBox.msgTimer.Dispose();  */
            //uncomment these to enabele timer
            result = Result.Cancel;
            newMessageBox.Close();
        }
